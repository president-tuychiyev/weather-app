<x-app-layout>
    <div class="py-16">
        <div class="xl:container m-auto px-6 text-gray-500 md:px-12 h-96 grid items-center">
            <form action="{{ route('signin') }}" class="max-w-sm mx-auto space-y-5" method="post">
                @csrf
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="text" id="username" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="Enter...">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex" x-data="{ showPassword: false }">
                        <input x-bind:type="showPassword ? 'text' : 'password'" id="password" class="rounded-none rounded-s-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="Enter...">
                        <span @click="showPassword = !showPassword" class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-s-0 border-gray-300 rounded-e-md cursor-pointer">
                            <svg class="w-4 h-4 text-gray-500" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 442.04 442.04" xml:space="preserve">
                                <g>
